...
nut.lang.Add("schema_author", "Создан %s.", language)
nut.lang.Add("create", "Создать", language)
nut.lang.Add("create_tip", "Создать персонажа, которым вы будите играть.", language)
nut.lang.Add("load", "Загрузить", language)
nut.lang.Add("load_tip", "Загрузить уже существующего персонажа.", language)
nut.lang.Add("return_tip", "Вернуться в игру.", language)
nut.lang.Add("leave", "Выйти.", language)
nut.lang.Add("leave_tip", "Выйти из текущего сервера.", language)
nut.lang.Add("return", "Вернутся", language)
nut.lang.Add("choose", "Выбрать", language)
nut.lang.Add("choose_tip", "Выбрать текущую опцию.", language)
nut.lang.Add("delete", "Удалить", language)
nut.lang.Add("delete_tip", "Удалить текущую опцию.", language)
nut.lang.Add("delete_question", "Вы уверены в том, что вы хотите удалить %s?", language)
nut.lang.Add("settings", "Настройки", language)
nut.lang.Add("settings_tip", "Эта вкладка позволит вам модифицировать персональный конфиг.", language)
nut.lang.Add("attribute", "Умения", language)
nut.lang.Add("attribute_tip", "Эта вкладка показывает умения вашего персонажа.", language)
nut.lang.Add("attribute_tip2", "Умения вашего персонажа могут быть усовершенствованны благодаря некоторыми конкретными действиями.", language)
nut.lang.Add("char_create_tip", "Заполните все следующие поля и нажмите 'Завершить'.", language)
nut.lang.Add("char_create_warn", "Информация о вашем персонаже должна быть соответсвенной.", language)
nut.lang.Add("inv_tip", "Вы можете использовать предметы в вашем инвентаре, нажимая левую кнопку мыши на иконке предмета.", language)
nut.lang.Add("business_tip", "Нажмите на иконку предмета, расположенную ниже, чтобы купить этот предмет.", language)
nut.lang.Add("scoreboard", "Таблица игроков", language)
nut.lang.Add("class_joined", "Вы присоединились к %s классу.", language)
nut.lang.Add("class_failed", "Вы не можете присоединится к этому классу.", language)
nut.lang.Add("pay_received", "Вы получили зарплату в %s.", language)
nut.lang.Add("item_pickup_samechar", "Вы не можете поднять предмет другого вашего персонажа.", language)
nut.lang.Add("no_perm_tied", "Вы не можете это сделать пока вы связаны.", language)
nut.lang.Add("no", "Нет", language)
nut.lang.Add("yes", "Да", language)
nut.lang.Add("male", "Мужчина", language)
nut.lang.Add("female", "Женшина", language)
nut.lang.Add("desc_char_req", "Описание вашего персонажа должно иметь не мение %s букв.", language)
nut.lang.Add("char_validating", "Сверяем информацию персонажа с датабазой сервера...", language)
nut.lang.Add("char_info", "Имя: %s\nDescription: %s\nFaction: %s", language)
nut.lang.Add("inventory", "Инвентарь", language)
nut.lang.Add("characters", "Персонажи", language)
nut.lang.Add("item_info", "Название: %s\nDescription: %s", language)
nut.lang.Add("none", "Ни один", language)
nut.lang.Add("no_desc", "Не существует потходящих описаний.", language)
nut.lang.Add("misc", "Остальное", language)
nut.lang.Add("dead_talk_error", "Вы не можете это сделать, когда вы мертвы.", language)
nut.lang.Add("nochar_talk_error", "Вам сначала нужен персонаж.", language)
nut.lang.Add("help", "Помощь", language)
nut.lang.Add("no_perm", "Вы не можете это сделать, %s.", language)
nut.lang.Add("no_ply", "Вы представили не существуешего игрока.", language)
nut.lang.Add("missing_arg", "Вы упустили аргумент #%s.", language)
nut.lang.Add("already_whitelisted", "Этот игрок уже имеет вайтлист.", language)
nut.lang.Add("not_whitelisted", "Этот игрок не имеет этого вайтлиста.", language)
nut.lang.Add("invalid_faction", "Вы предоставили не существующую фракцию.", language)
nut.lang.Add("blacklisted", "%s исключил %s из %s фракции.", language)
nut.lang.Add("whitelisted", "%s присоединил %s к %s фракции.", language)
nut.lang.Add("flags_give", "%s дал '%s' флаг(ги) %s.", language)
nut.lang.Add("flags_take", "%s изъял '%s' флаг(ги) у %s.", language)
nut.lang.Add("no_invspace", "Этот предмет не помищается в ваш инвентарь.", language)
nut.lang.Add("business", "Бизнес", language)
nut.lang.Add("no_afford", "У вас недостаточно средств чтобы купить это.", language)
nut.lang.Add("vendor_no_afford", "У раздатчика недостаточно средств чтобы купить это.", language)
nut.lang.Add("vendor_cash", "Раздатчик имеет %s.", language)
nut.lang.Add("classes", "Классы", language)
nut.lang.Add("purchased", "Вы купили %s.", language)
nut.lang.Add("purchased_for", "Вы купили %s за %s.", language)
nut.lang.Add("sold", "Вы продали %s за %s.", language)
nut.lang.Add("notenoughitem", "У вас недостаточно %s.", language)
nut.lang.Add("points_left", "У вас осталось %s очков.", language)
nut.lang.Add("finish", "Завершить", language)
nut.lang.Add("name", "Имя", language)
nut.lang.Add("name_desc", "Это имя вашего персонажа, которым вы будите играть.", language)
nut.lang.Add("desc", "Описание", language)
nut.lang.Add("gender", "Пол", language)
